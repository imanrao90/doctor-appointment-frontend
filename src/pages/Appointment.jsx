    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
          ...
          <div className="flex items-center gap-2 text-sm mt-1 text-gray-600">
            ...
            <button className="py-0.5 px-2 border border-gray-400 text-xs rounded-full cursor-pointer">{docInfo.experience}</button>
          </div>
      ...
      <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
        ...
        <button
          ...
          className="bg-blue-500 text-white text-sm font-light px-14 py-3 rounded-full my-6 cursor-pointer">Book an appointment</button>
      </div>
