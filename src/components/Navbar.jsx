    ...
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400">
      ...
      <ul className="hidden md:flex items-start gap-5 font-medium">
        <NavLink to='/'>
          ...
          <hr className="outline-none h-0.5 bg-blue-600 w-3/5 m-auto hidden" />
        </NavLink>
        <NavLink to='/doctors'>
      ...
      <div className="flex items-center gap-4">
        {
          token && userData ?
            <div className="flex cursor-pointer gap-2 group relative">
            ...
            </div> : <button onClick={() => navigate('/login')} className="bg-blue-600 text-white px-8 py-3 rounded-full font-light cursor-pointer">Create Account</button>
        }
